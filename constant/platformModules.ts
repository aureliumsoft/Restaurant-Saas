...
export const PLATFORM_ADMIN_MODULES = [
  ...
  { moduleKey: 'admin_documentation', title: 'Documentation', path: '/admin/documentation' },
  { moduleKey: 'admin_blog', title: 'Blog posts', path: '/admin/blog' },
  { moduleKey: 'admin_faqs', title: 'FAQs', path: '/admin/faqs' },
