                      ...
                      return (
                        <div className="shrink-0 border-t border-[#ececf0] bg-white p-4 pt-3">
                          <button
                            ...
                            disabled={isDisabled}
                            onClick={() => {
                              // Decline optional product recommendation entirely
                              // so the picker does not reopen the same step.
                              if (isOptional && !hasSelectedVar) {
                                setNestedConfigs((prev) => {
                                  const nextNested = {
                                    ...prev,
                                    [currentRecGroupId]: emptyOptionNestedConfig(),
                                  };
                                  queueMicrotask(() => {
                                    applyNextPendingPicker(
                                      selectedVariationId,
