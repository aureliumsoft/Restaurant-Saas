/** Shared 80mm thermal receipt print styles and header (logo → name → branch). */
...
/** Base CSS for POS / kiosk 80mm thermal print windows. */
export function getThermalReceiptDocumentCss(): string {
  return `
      ...
      .receipt-logo { width: 48px; height: 48px; object-fit: cover; border-radius: 999px; border: 1px solid #ddd; }
      .receipt-brand { font-size: 14px; font-weight: 700; line-height: 1.2; margin: 0 auto; max-width: 70mm; }
      .receipt-branch { font-size: 10px;  margin-top: 2px; }
      .receipt-datetime {  font-size: 10px; margin-top: 2px; }
      .receipt-line { font-size: 10px; margin-top: 1px; text-align: left; }
      .sep { border-top: 1px dashed; margin: 6px 0; }
      table { width: 100%; border-collapse: collapse; }
      th, td { padding: 2px 0; font-size: 10px; vertical-align: top; text-align: left; }
